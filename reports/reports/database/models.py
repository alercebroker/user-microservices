...
class Report(BaseModel, metaclass=ModelMetaclass):
    ...
    __indexes__ = [IndexModel([("owner", 1), ("object", 1), ("report_type", 1)], unique=True), IndexModel([("date", -1)]), IndexModel([("report_type", 1)])]
    ...
    report_type: Literal["TOM", "Bogus"] = Field(..., description="Type of report")
